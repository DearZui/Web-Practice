import generateSummary from '../src/generateSummary.js';
import chai from 'chai';

let expect = chai.expect;

let input = `2016-06-02 20:00~22:00 7
...
describe('generateSummary', function() {
  if('应该像pdf那样输出', function() {
    expect(generateSummary(input).to.be.equal(output));
  });
});